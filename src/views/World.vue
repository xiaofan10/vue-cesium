...
onMounted(async () => {
  ...
  // let tdtLayer = new UrlTemplateImageryProvider({
  ...
  // Cesium 官方提供的资源touken
  // const customMap = Cesium.ArcGisMapServerImageryProvider.fromUrl('https://services.arcgisonline.com/arcgis/rest/services/World_Terrain_Base/MapServer')
  ...
  Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJkY2UyZDI3NS02M2NjLTQ1OTUtODBmMC03YWNhYzk1NzU2M2MiLCJpZCI6MTU2MDQyLCJpYXQiOjE2OTAyMDc4ODR9.BmN3pOpnSPgJa2eBzYBHt5xrnMaIlV7MdcNrvowXpfs'
  // ArcGis 使用的token https://developers.arcgis.com
  // Cesium.ArcGisMapService.defaultAccessToken = 'AAPKa334085b43db448b9396da0be43d8eb0E00TOp76Ro_zfiObeIZ-Bkhu1q5J1GEASdk78VTLE52iPRJJa6E_O4O84zOVYEp1'
  const viewer = new Cesium.Viewer('cesiumContainer', {
    baseLayerPicker: false,
    baseLayer: Cesium.ImageryLayer.fromProviderAsync(Cesium.IonImageryProvider.fromAssetId(4))
  })
