 ...
 */
function installRadarWaveMaterialProperty(Cesium) {
  ...
  Cesium.Scene.RadarWaveMaterialProperty = RadarWaveMaterialProperty
...
export { installRadarWaveMaterialProperty }
