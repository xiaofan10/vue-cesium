 ...
 */
function installEllipsoidTrailMaterialProperty(Cesium) {
  ...
  Cesium.Scene.EllipsoidTrailMaterialProperty = EllipsoidTrailMaterialProperty
...
export { installEllipsoidTrailMaterialProperty }
